...
const UINT ExecuteIndirect::COMMAND_SIZE_PER_FRAME = ExecuteIndirect::TRIANGLE_COUNT * sizeof(IndirectCommand);
const UINT ExecuteIndirect::COMMAND_BUFFER_COUNTER_OFFSET = alignForUavCounter(ExecuteIndirect::COMMAND_SIZE_PER_FRAME);
const float ExecuteIndirect::TRIANGLE_HALF_WIDTH = 0.05f;
const float ExecuteIndirect::TRIANGLE_DEPTH = 1.0f;
const float ExecuteIndirect::CULLING_CUT_OFF = 0.5f;
...
ExecuteIndirect::ExecuteIndirect(HWND hWnd)
    :mFrameIndex(0),
    mCullingScissorRect(),
...
void ExecuteIndirect::loadPipeline() {
...
void ExecuteIndirect::loadAssets() {
    {
        //ルートシグネチャ作成
