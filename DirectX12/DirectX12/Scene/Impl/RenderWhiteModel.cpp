...
RenderWhiteModel::RenderWhiteModel() {
...
void RenderWhiteModel::load(Framework::Scene::Collecter& collecter) { }

void RenderWhiteModel::update() {
    mRotate += 1.0f;
...
bool RenderWhiteModel::isEndScene() const {
    return false;
}

void RenderWhiteModel::draw() {
...
void RenderWhiteModel::end() { }

Framework::Define::SceneType RenderWhiteModel::next() {
